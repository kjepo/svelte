<script>
    ...
    import { Plus, LogOut, Trash2, Upload } from '@lucide/svelte';
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {#each projects as project}
                <div class="rounded-lg border bg-card p-4 shadow-sm">
			      ...
			      <b>Type:</b> {project.album_type}
			    </p>
			    <p class="text-sm text-muted-foreground">
			      <b>Created:</b> {formatDate(project.created_at)}
			    </p>
                        </div>
                        <div class="flex gap-1">
                            <Button variant="ghost" size="icon-sm" onclick={() => importProject(project)}>
